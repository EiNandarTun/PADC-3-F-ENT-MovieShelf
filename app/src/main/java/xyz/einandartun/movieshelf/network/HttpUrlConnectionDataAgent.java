package xyz.einandartun.movieshelf.network;
...
import xyz.einandartun.movieshelf.network.responses.GetMoviesResponse;

/**
 * Created by einandartun on 12/26/17.
 */

public class HttpUrlConnectionDataAgent implements MoviesShelfDataAgent{
    ...
    public void loadMovies() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                Log.d(MovieShelfApp.LOG_TAG, "doInBackground: ");
                ...
                try {
                    ...
                    Log.d(MovieShelfApp.LOG_TAG, "response String: " +responseString);

                    Gson gson = new Gson();
                    GetMoviesResponse getMoviesResponse = gson.fromJson(responseString, GetMoviesResponse.class);
                    Log.d(MovieShelfApp.LOG_TAG, "getNewResponse: ");

                    LoadedMoviesEvent event = new LoadedMoviesEvent(getMoviesResponse.getPopularMovie());
